...
tart = "lemon meringue pies"
filled = "peanut butter buttercream donuts"
cover = "chocolate cake icing"

p "Dale ordered two #{tart} and a box of #{filled} topped with #{cover}."
